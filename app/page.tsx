		...
		<div className="  bg-white text-gray-900">
			...
			<main className="flex flex-col items-center text-center py-12">
				<h2 className="text-4xl font-bold mb-6">
					The Best Workers' Compensation Insurance Portal in
					Uganda
				</h2>
				<p className="text-lg mb-8 max-w-2xl">
					Explore the top insurance providers, compare their
					policies, and get your employees protected with just a
					few clicks.
				</p>
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 gap-8 max-w-5xl mx-auto">
					<div className="p-6 bg-gray-100 rounded-lg">
						...
						<p className="mt-4 text-gray-700">
							"This portal made it incredibly easy to find
							and compare policies. We now have the best
					...
					<div className="p-6 bg-gray-100 rounded-lg">
						...
						/>
						<p className="mt-4 text-gray-700">
							"The customer support was fantastic. They
							guided us every step of the way during the
							policy application."
						</p>
						<h5 className="mt-4 font-semibold">
							– Sarah K., CEO
			...
			>
				...
				<p className="mt-4 text-gray-600">
					Join thousands of Ugandan businesses that trust us for
